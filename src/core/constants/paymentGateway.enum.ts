...
export interface OrderInterface {
    ...
    gateway: string,
    status: number,
    orderId: string, // unique per request // YYMMDD-orderId
    requestId: string, // unique per request // YYMMDD-orderId
    title: string,
    description: string,
    total: number,
    subtotal: number,
...
export interface RequestMomoInterface {
    id: number, // id unique
    orderId: string, // id unqiue
    requestId: string, // id unique
    title: string, // title or description order
    amount: string, // total price
    extraData: string, // extradata: 'email=thanhnguyen@wearetopgroup.com;name=nguyentanthanh'
}
...
export interface RequestZaloInterface {
    id: number, // id unique
    app_trans_id: string, // YYMMDD-orderId
    title: string, // title order
